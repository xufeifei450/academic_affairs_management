      ...
      <div class="manager-main-left">
        <el-menu  router style="border: none" :default-active="$route.path">
          ...
          <el-submenu index="info">
            <template slot="title">
              <i class="el-icon-bell"></i><span>信息公告</span>
            </template>
          ...
          <el-submenu index="administration">
            <template slot="title">
              <i class="el-icon-school"></i><span>行政管理</span>
            </template>
          ...
          <el-submenu index="teach">
            <template slot="title">
              <i class="el-icon-date"></i><span>教学管理</span>
            </template>
          ...
          <el-submenu index="educational">
            <template slot="title">
              <i class="el-icon-price-tag"></i><span>教务管理</span>
            </template>
