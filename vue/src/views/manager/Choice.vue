    ...
    <div>
        <div class="table">
            <el-table :data="tableData" stripe>
                ...
                <el-table-column prop="score" label="学分" width="50"show-overflow-tooltip></el-table-column>
                ...
                <el-table-column prop="studentName" label="选课学生" width="70"show-overflow-tooltip></el-table-column>
