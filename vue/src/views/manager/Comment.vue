  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe>
        ...
        <el-table-column prop="name" label="课程名称" show-overflow-tooltip width="150px"></el-table-column>
        <el-table-column prop="teacher" label="授课教师" width="100px"></el-table-column>
<!--        <el-table-column prop="student" label="评教学生" width="100px"></el-table-column>-->
