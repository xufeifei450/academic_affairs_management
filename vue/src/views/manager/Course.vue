<template>
  <div>
    <div class="search">
      ...
      <el-button type="info" plain icon="el-icon-search" style="margin-left: 10px" @click="load(1)">查询</el-button>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        <el-table-column type="selection" width="45" align="center" v-if="user.role==='ADMIN'"></el-table-column>
        ...
        <el-table-column prop="score" label="学分" width="45" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column label="操作" width="180" align="center">
          <template v-slot="scope">
            ...
            <el-button plain type="success" @click="choiceCourse(scope.row)" size="mini"  v-if="user.role ==='STUDENT'" :disabled="scope.row.status !=='未开课'">选课</el-button>
      ...
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="teacherId" label="授课教师">
          <el-select v-model="form.teacherId" placeholder="请选择教师" style="width: 100%" :disabled="user.role !== 'ADMIN'">
            <el-option v-for="item in teacherData"  :key="item" :label="item.name" :value="item.id"></el-option>
          </el-select>
        </el-form-item>
